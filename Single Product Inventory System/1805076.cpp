...
void report() {
    ...
    out << "(" << small_s << ", " << cap_s << ")" << "            " 
    << avg_order_cost+avg_holding_cost+avg_shortage_cost << "             " << avg_order_cost 
    << "             " << avg_holding_cost << "             " << avg_shortage_cost << endl << endl;
}
...
void print_inventory_details() {
    ...
    out << "Number of policies: " << num_of_policies << endl << endl;

    out << "Policies: " << endl;
    out << "--------------------------------------------------------------------------------------------------" << endl;
    out << " Policy        " << "Avg_total_cost     " << "Avg_ordering_cost      " << "Avg_holding_cost     " << "Avg_shortage_cost" << endl;
    out << "--------------------------------------------------------------------------------------------------" << endl;
    out << endl;
